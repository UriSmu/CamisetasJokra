...
const supabaseKey = import.meta.env.VITE_SUPABASE_KEY // Usa VITE_ para variables de entorno en Vite
...
function App() {
  ...
  if (gracias) {
    return <h2 style={{ color: 'green' }}>GRACIAS POR PARTICIPAR</h2>
  }

  return (
    <div>
      <h1>Formulario Remeras</h1>
      <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 12, maxWidth: 300, margin: 'auto' }}>
        <input
          type="text"
          placeholder="Nombre"
          value={nombre}
